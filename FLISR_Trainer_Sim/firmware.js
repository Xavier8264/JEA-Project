/* ===========================================================================
 * FLISR_Trainer firmware port
 * ---------------------------------------------------------------------------
 * A line-for-line JavaScript port of the LOGIC section of
 * FLISR_Trainer/FLISR_Trainer.ino, meaning everything below the line
...
const PORTED_LOGIC_SHA256 = '18edf6abae7d42c43cb6e0b21900112321dac56a6d81f98042918718a120eb65';
  ...
  function render() {
    ...
    for (let s = 0; s < NUM_SEGMENTS; s++) {
      ...
      for (let i = 0; i < len; i = u8(i + 1)) {
        ...
        if (!over) zn = D.ZN_HID;
        setLed(idx, colorForZone(zn, blinkOn)); idx = u16(idx + 1);
      }
    }
