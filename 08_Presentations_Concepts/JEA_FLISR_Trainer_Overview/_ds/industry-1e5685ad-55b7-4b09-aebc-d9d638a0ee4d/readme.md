...
Barlow Condensed for headings over Barlow for body text, loaded as `--font-heading` / `--font-body`. Density 0.85x and radius 4px are already baked into the `--space-*` / `--radius-*` scales — use the variables, not raw numbers.
